        ...
        <div class="faciliteiten-container">
            <div class="faciliteiten-col">
                <div class="ideaal">
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-square-parking parkeer"></i>Parkeerplaats</h2>
                        </li>
                        <li>
                            <p class="parkeer-tekst">Privé parkeren is gratis. Je kunt parkeren bij de accommodatie.
                                Reserveren is niet noodzakelijk.</p>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-wifi wifi"></i> Internet</h2>
                        </li>
                        <li>
                            <p class="wifi-tekst">WiFi is beschikbaar in de gehele accommodatie. Deze service is gratis.</p>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-kitchen-set"></i> Keuken</h2>
                        </li>
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-bed"></i> Slaapkamer</h2>
                        </li>
            ...
            <div class="faciliteiten-col">
                <div class="badkamer">
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-couch"></i> Badkamer</h2>
                        </li>
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-tv"></i> Media & Technologie</h2>
                        </li>
                        <li><i class="fa-solid fa-check check"></i> Flatscreen-Tv</li>
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-bed"></i> Kamerfaciliteiten</h2>
                        </li>
                    ...
                    <ul>
                        <li>
                            <h2 class="icons"><i class="fa-solid fa-wheelchair"></i> Toegangelijkheid</h2>
                        </li>
                        <li><i class="fa-solid fa-check check"></i> Bovenverdieping alleen bereikbaar per trap</li>
                    </ul>
                    <ul>
                        <li>
                            <h2 class="icons"> <i class="fa-solid fa-sun"></i> Buiten</h2>
                        </li>
            ...
            <div class="faciliteiten-col">
                ...
                <ul>
                    <li>
                        <h2 class="icons"><i class="fa-solid fa-door-open"></i> Kenmerken gebouw</h2>
                    </li>
                    <li><i class="fa-solid fa-check check"></i> Vrijstaand</li>
                </ul>
                <ul>
                    <li>
                        <h2 class="icons"><i class="fa-solid fa-sink"></i> Diensten receptie</h2>
                    </li>
                    <li><i class="fa-solid fa-check check"></i> Factuur wordt versterkt</li>
                </ul>
                <ul>
                    <li>
                        <h2 class="icons"></h2><i class="fa-solid fa-people-roof"></i> Entertainment en familiediensten
                    </li>
                ...
                <ul>
                    <li>
                        <h2 class="icons"><i class="fa-solid fa-lock"></i></h2>
                    </li>
                    <li><i class="fa-solid fa-check check"></i> Rookmelder</li>
                </ul>
                <ul>
                    <li>
                        <h2 class="icons"><i class="fa-solid fa-comments"></i> Gesproken talen</h2>
                    </li>
