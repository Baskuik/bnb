...
<div class="container mx-auto max-w-md mt-10">
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="mb-4">
            <label for="password" class="block mb-2 font-semibold">Nieuw wachtwoord</label>
        ...
        <div class="mb-4">
            <label for="password_confirmation" class="block mb-2 font-semibold">Bevestig nieuw wachtwoord</label>
